...
- [x] 17. 변경 가능성을 최소화하라 (모리)  
- [x] 18. 상속보다는 컴포지션을 사용하라 (태태)  
- [x] 19. 상속을 고려해 설계하고 문서화하라. 그러지 않았다면 상속을 금지하라 (모리)  
- [x] 20. 추상 클래스보다는 인터페이스를 우선하라 (태태)  
- [x] 21. 인터페이스는 구현하는 쪽을 생각해 설계하라 (모리)  
- [x] 22. 인터페이스는 타입을 정의하는 용도로만 사용하라 (태태)  
- [x] 23. 태그 달린 클래스보다는 클래스 계층구조를 활용하라 (모리)  
- [x] 24. 멤버 클래스는 되도록 static으로 만들라 (태태)  
- [x] 25. 톱레벨 클래스는 한 파일에 하나만 담으라 (모리)  
- [x] 26. 로 타입은 사용하지 말라 (태태)  
- [x] 27. 비검사 경고를 제거하라 (모리)  
- [x] 28. 배열보다는 리스트를 사용하라 (태태)  
- [x] 29. 이왕이면 제네릭 타입으로 만들라 (모리)  
